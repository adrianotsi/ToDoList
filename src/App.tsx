...
export default function App() {
  ...
  async function handleSubmit(event: FormEvent){
    ...
    try{
      ...
      if(!nameTaskRef.current?.value || !dueDateRef.current?.value || !priorityRef.current?.value){
        return  MySwal.fire({
          title: "Error!",
          html: `<span>Something is wrong.</span><br><span>Check that you have filled in all the fields</span>`,
          icon: "error"
        });
      }
